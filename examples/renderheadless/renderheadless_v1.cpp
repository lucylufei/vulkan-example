...
public:
	...
	*/
	...
	void createBottomLevelAccelerationStructure(const VkGeometryNV* geometries)
	{
		...
		memoryAllocateInfo.memoryTypeIndex = getMemoryTypeIndex(memoryRequirements2.memoryRequirements.memoryTypeBits, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
	...
	VulkanExample()
	{
		...
		*/
		...
		{
			// NOTE: Triangle vertices VK_FORMAT_R8G8B8A8_UNORM
			...
			// Copy input data to VRAM using a staging buffer
			{
				...
				*/
				...
				geometry.geometry.triangles.indexCount = indexBufferSize;
		...
		*/
		...
		// QUESTION: Why is the format initialized to something else? 
		VkFormat colorFormat = VK_FORMAT_R8G8B8A8_UNORM;
		VkFormat depthFormat;
		vks::tools::getSupportedDepthFormat(physicalDevice, &depthFormat);
		// NOTE: depth format is VK_FORMAT_D32_SFLOAT_S8_UINT
		{
			// Color attachment
